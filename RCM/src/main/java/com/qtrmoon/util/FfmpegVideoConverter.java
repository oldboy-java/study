...
public class FfmpegVideoConverter {
	...
	public static void main(String args[]) throws IOException {
		boolean convert = new FfmpegVideoConverter("E:/movie.flv",null,"G:/ffmpeg-20171225-be2da4c-win64-static/bin/").convert(VideoEnum.MP4.getVideoType());
	 ...
	 * @param ffmpegPath ffmpegPath安装路径
	 */
	public FfmpegVideoConverter(String inputPath,String outputPath,String ffmpegPath){
	...
	private  boolean processFlv() {
		...
		if(outputPath==null || "".equals(outputPath)){
			command.add(inputPath.substring(0, inputPath.lastIndexOf(".")) + ".flv");
		}else{
	...
	private boolean processMp4() {
		...
		if(outputPath==null || "".equals(outputPath)){
			command.add(inputPath.substring(0, inputPath.lastIndexOf(".")) + ".mp4");
			//sb.append(inputPath.substring(0, inputPath.lastIndexOf(".")) + ".mp4");
		}else{
			command.add(outputPath);
