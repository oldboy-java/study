...
<html>
	...
	<body>
		约束树
		<table border="1">
		    <tr><td>省</td><td><pageFmt:dict dictId="TEST_TREE" reign="#HEAD_shi" name="sheng"/></td></tr>
		    <tr><td>市</td><td><pageFmt:dict dictId="TEST_TREE" reign="xian" name="shi"/></td></tr>
		    <tr><td>县</td><td><pageFmt:dict dictId="TEST_TREE" reign="#TAIL" name="xian"/></td></tr>
	    </table>
	    不同字典表也可以：
	    <table border="1">
		    <tr><td>市</td><td><pageFmt:dict dictId="TEST_TREE" reign="#HEAD_subarea" name="area"/></td></tr>
		    <tr><td>县</td><td><pageFmt:dict dictId="TEST_TREE" reign="#TAIL" name="subarea"/></td></tr>
	    </table>
