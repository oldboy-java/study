...
<html>
	...
	<body>
		选择：
		<dc:insertList dictId="TEST_GROUP" name="dqbm" style="combo_group_multi" cssWidth="300px" value="8,9,a" bind="select:fun,unselect:fun2"/>
		
		<div style="margin:20px 0;">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="dqbmDict.select('3')">Select</a>
