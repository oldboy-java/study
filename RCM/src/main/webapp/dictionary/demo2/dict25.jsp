...
<html>
	...
	<body>
		选择地区：
		<dc:insertList dictId="TEST_GROUP" name="dqbm" style="combo_grid:{text:书名,author:作者,publish:出版社,price:价格,panelWidth:500}" cssWidth="200px" value="8" bind="select:fun"/>
