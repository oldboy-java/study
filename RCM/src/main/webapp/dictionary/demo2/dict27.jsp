...
<html>
	<head>
		...
		function fun(index,json){//{id:'',text:''}
			info(index+":"+json.id+","+json.label+","+json.author+","+json.publish);
		}
		</script>
	</head>
	<body>
		<dc:includeList dictId="TEST_GROUP" name="dqbm" title="选择书籍" style="bill_grid:{label:书名,author:作者,publish:出版社}" cssWidth="300px" value="8" bind="select:fun"/>
