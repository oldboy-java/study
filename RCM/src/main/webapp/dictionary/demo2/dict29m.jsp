...
<html>
	...
	<body>
		<dc:includeList dictId="TEST_GROUP" name="dqbm" title="Ñ¡ÔñÊé¼®" style="bill_info_multi" cssWidth="200px" value="8,9" bind="select:fun,unselect:fun2"/>
		
		<div style="margin:20px 0;">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="dqbmDict.check('2,a,b')">Select</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="dqbmDict.checkRow('5,6,8')">SelectRow</a>
