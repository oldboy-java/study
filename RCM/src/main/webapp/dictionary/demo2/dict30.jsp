...
<html>
	<head>
		...
		function fun(index,json){//{id:'',text:''}
			info("check:"+index+":"+json.id+","+json.text);
		}
		function fun2(index,json){//{id:'',text:''}
			info("uncheck:"+index+":"+json.id+","+json.text);
		}
		function fun3(index,json){//{id:'',text:''}
	...
	<body>
		Ñ¡ÔñµØÇø£º
		<dc:includeList dictId="SYS_ROLE" name="dqbm" style="bill_checkbox" cssWidth="200px" value="8" bind="check:fun,uncheck:fun2,clickRow:fun3"/>
