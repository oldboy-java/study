...
<html>
	...
	<body>
		选择地区：
		<dc:includeTree dictId="TEST_TREE" name="dqbm" style="synch_multi" cssWidth="200px" value="130105,130108" dynroot="130100" bind="select:fun,expand:fun2,collapse:fun3,check:fun4"/>
		
		<div style="margin:20px 0;">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="dqbmDict.select('130103,130105')">Select</a>
