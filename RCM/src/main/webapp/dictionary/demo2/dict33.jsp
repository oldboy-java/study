...
<html>
	...
	<body>
		选择地区：
		<dc:includeTree dictId="TEST_TREE" name="dqbm" style="asynch_single" cssWidth="200px" value="131023" bind="select:fun,expand:fun2,collapse:fun3"/>
		
		<div style="margin:20px 0;">
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="dqbmDict.select('130000')">Select</a>
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="dqbmDict.expandTo('140101')">ExpandTo</a>
			|
