...
!function(t, a, e, i) {
    ...
    n.prototype = {
        ...
        render: function() {
            ...
            this.totalPage = '<span>共'+e+'页',
            this.checkPage(),
            this.isRender && n.html("<div class='ui-pagination-container'>" + this.homePage + this.prevPage + i + this.nextPage + this.endPage+this.totalPage + "</div>")
        },
        checkPage: function() {
            var t = this.opts,
            a = parseInt(this.total),
            e = parseInt(this.current);
