...
(function($){
    $.fn.html5uploader = function(opts){
        ...
        var defaults = {
            ...
            buttonText:'上传资源',//上传按钮上的文字
            removeTimeout: 1000,//上传完成后进度条的消失时间
            itemTemplate:'<li id="${fileID}file"><div class="upload-img"><img src="img/text.png" class="upload-bg"><img class="upload-type" src="img/pdf2.png"></div><div class="upload-right"><p class="filename">${fileName}</p><div class="progress"><div class="progressbar"></div></div><span class="progressnum">0/${fileSize}</span><div class="upload-p"><span class="upload-input"><a class="upload-fm">上传封面</a><input type="file"/></span><a class="uploadbtn">上传</a><a class="delfilebtn">删除</a></div></div></li>',//上传队列显示的模板,最外层标签使用<li>
