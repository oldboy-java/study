...
<table id="jlcxGrid" title="" fitcolumns=true
	data-options="singleSelect:false,pagination:true,rownumbers:true,fit:true,striped:true,toolbar:'#jlcxGridToolbar',collapsible:true,url:'/${projectName}/zygl/zy/schScrZydxsl.action',method:'get'">
	<thead>
		<tr>
			<th data-options="field:'checkbox',checkbox:true" ></th>
			<th data-options="field:'scr',width:80,sortable:true">上传人</th>
