...
<table id="jlcxGrid" title="" fitcolumns=true
	data-options="singleSelect:false,pagination:true,rownumbers:true,fit:true,striped:true,toolbar:'#jlcxGridToolbar',collapsible:true,url:'/${projectName}/zygl/zy/schZysh.action',method:'get'">
	<thead>
		<tr>
			<th data-options="field:'checkbox',checkbox:true" ></th>
			<th data-options="field:'ssxkid',width:80,sortable:true">资源类别</th>
			<th data-options="field:'shzt',width:80,sortable:true">审核状态</th>		
