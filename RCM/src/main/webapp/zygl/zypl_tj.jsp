...
<table id="jlcxGrid" title="" fitcolumns=true
	data-options="singleSelect:false,pagination:true,rownumbers:true,fit:true,striped:true,toolbar:'#jlcxGridToolbar',collapsible:true,url:'/${projectName}/zygl/zypl/schZyplcs.action',method:'get'">
	<thead>
		<tr>
			...
			<th data-options="field:'amount',sortable:true">评论次数</th>
