...
<table id="jlcxGrid" title="" fitcolumns=true
	data-options="singleSelect:false,pagination:true,rownumbers:true,fit:true,striped:true,toolbar:'#jlcxGridToolbar',collapsible:true,url:'/${projectName}/zygl/zyxz/schZyxzcs.action',method:'get'">
	<thead>
		<tr>
			...
			<th data-options="field:'amount',sortable:true">下载次数</th>
